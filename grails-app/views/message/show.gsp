...
<html>
    ...
    <body>
        <div class="nav">
			...
			<span class="menuButton"><g:link class="create" action="create" params='["event.id":"${messageInstance?.event?.id}"]'><g:message code="default.new.label" args="[entityName]" /></g:link></span>
        </div>
        <div class="body">
